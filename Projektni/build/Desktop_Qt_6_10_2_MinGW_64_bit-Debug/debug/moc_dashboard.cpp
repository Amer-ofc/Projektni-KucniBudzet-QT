...
template <> constexpr inline auto Dashboard::qt_create_metaobjectdata<qt_meta_tag_ZN9DashboardE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        ...
        "",
        "on_btnGrafikon_clicked",
        "on_btnDodajPrihod_clicked",
        "on_btnDodajRashod_clicked",
        "on_btnObrisi_clicked",
        "on_cbMjesec_currentTextChanged",
        "arg1",
        "on_cbGodina_currentTextChanged"
    };

    QtMocHelpers::UintData qt_methods {
        // Slot 'on_btnDashboard_clicked'
        QtMocHelpers::SlotData<void()>(1, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_btnGrafikon_clicked'
        QtMocHelpers::SlotData<void()>(3, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_btnDodajPrihod_clicked'
        QtMocHelpers::SlotData<void()>(4, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_btnDodajRashod_clicked'
        QtMocHelpers::SlotData<void()>(5, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_btnObrisi_clicked'
        QtMocHelpers::SlotData<void()>(6, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_cbMjesec_currentTextChanged'
        QtMocHelpers::SlotData<void(const QString &)>(7, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::QString, 8 },
        }}),
        // Slot 'on_cbGodina_currentTextChanged'
...
void Dashboard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->on_btnGrafikon_clicked(); break;
        case 2: _t->on_btnDodajPrihod_clicked(); break;
        case 3: _t->on_btnDodajRashod_clicked(); break;
        case 4: _t->on_btnObrisi_clicked(); break;
        case 5: _t->on_cbMjesec_currentTextChanged((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        case 6: _t->on_cbGodina_currentTextChanged((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
}
